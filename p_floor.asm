...
; bp - 2    floortype
; bp - (2 + (MAX_ADJOINING_SECTORS_IN_WORDS)) secnumlist
; bp - (2 + (MAX_ADJOINING_SECTORS_IN_WORDS) + 2) secnumlist iter
...
lea   dx, [bp - (2 + (MAX_ADJOINING_SECTORS_IN_WORDS))]
...
push  si ; bp - (2 + (MAX_ADJOINING_SECTORS_IN_WORDS)). pop at end of loop...
...
push  bp
mov   bp, sp
sub   sp, (010h + (MAX_ADJOINING_SECTORS_IN_WORDS))
