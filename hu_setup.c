...
// todo : if we put these arrays into code instead of a struct, it would get absorbed 
// into the overlay and take up a few less hundred bytes of conventional memory...
