...
;pageswapargs
	...
	_EPR 7	 					 					PAGE_9000_OFFSET ;pageswapargs_rend_9000_size
	_EPR 8	 				 						PAGE_9400_OFFSET
	...
	_EPR PHYSICS_RENDER_9800_PAGE 					PAGE_8C00_OFFSET  ; put colormaps where vissprites used to be?
		;render 9000 to 6000
	_EPR 7						 					PAGE_6000_OFFSET ;pageswapargs_render_to_6000_size
	_EPR 8	 										PAGE_6400_OFFSET
		; palette
