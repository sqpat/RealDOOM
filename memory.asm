...
IFDEF COMPILE_CHIPSET
	...
	dw	_NPR(PAGE_4000_OFFSET),	 _NPR(PAGE_4400_OFFSET),	 _NPR(PAGE_4800_OFFSET),	 _NPR(PAGE_4C00_OFFSET)
	dw	_NPR(PAGE_5000_OFFSET),  _NPR(PAGE_5400_OFFSET),	 _NPR(PAGE_5800_OFFSET),	 _NPR(PAGE_5C00_OFFSET)
	dw	_NPR(PAGE_6000_OFFSET),  _NPR(PAGE_6400_OFFSET),	 _EPR(13),	                 _EPR(14)
	dw	_NPR(PAGE_7000_OFFSET),	 _NPR(PAGE_7400_OFFSET),	 _NPR(PAGE_7800_OFFSET),	 _NPR(PAGE_7C00_OFFSET)
	dw	_NPR(PAGE_8000_OFFSET),	 _NPR(PAGE_8400_OFFSET),	 _NPR(PAGE_8800_OFFSET),	 _NPR(PAGE_8C00_OFFSET)
	dw	_EPR(15)
	dw	_EPR(FIRST_LUMPINFO_LOGICAL_PAGE)    
	dw	_EPR(FIRST_LUMPINFO_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_LUMPINFO_LOGICAL_PAGE + 2)

		; render
	dw	_EPR(0),				 _EPR(1),					 _EPR(2),					 _EPR(3)
	dw	_EPR(FIRST_TEXTURE_LOGICAL_PAGE + 0),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 1),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 2),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 3)	  ; texture cache area
	dw	_EPR(FIRST_TEXTURE_LOGICAL_PAGE + 4),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 5),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 6),	 _EPR(FIRST_TEXTURE_LOGICAL_PAGE + 7)	  ; texture cache area
	dw	_EPR(7),				 _EPR(8),					 _EPR(9),					 _EPR(10)
	dw	_EPR(4),				 _EPR(5),					 _EPR(6),					 _EPR(EMS_VISPLANE_EXTRA_PAGE)
	dw	_EPR(11)
	dw	_EPR(12)
	dw	_EPR(13)
	dw	_EPR(14)
	...
	dw	_EPR(0),				 _EPR(1),					 _EPR(2),					 _EPR(3)
		; status/hud
	dw	_NPR(PAGE_9C00_OFFSET) 		  ;SCREEN4_LOGICAL_PAGE
	dw	_EPR(FIRST_STATUS_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_STATUS_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_STATUS_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_STATUS_LOGICAL_PAGE + 3)
	dw	_NPR(PAGE_6000_OFFSET) 		  ; STRINGS_LOGICAL_PAGE
		; demo
	dw	_EPR(FIRST_DEMO_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_DEMO_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_DEMO_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_DEMO_LOGICAL_PAGE + 3)
	; we use 0x5000 as a  'scratch' page frame for certain things
	; scratch 5000
	dw	_EPR(FIRST_SCRATCH_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_SCRATCH_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_SCRATCH_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_SCRATCH_LOGICAL_PAGE + 3)
	...
	dw	_EPR(FIRST_SCRATCH_LOGICAL_PAGE + 3)
		...
		;  RenderPlane
	dw	_EPR(FLAT_DATA_PAGES)
	dw	_EPR(FLAT_DATA_PAGES+1)
	dw	_EPR(FLAT_DATA_PAGES+2)
	dw	_EPR(PALETTE_LOGICAL_PAGE)       ; SPAN CODE SHOVED IN HERE. used to be mobjposlist but thats unused during planes
															
		; flat cache
	dw	_EPR(FIRST_FLAT_CACHE_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_FLAT_CACHE_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_FLAT_CACHE_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_FLAT_CACHE_LOGICAL_PAGE + 3)
		; sprite cache
	dw	_EPR(FIRST_SPRITE_CACHE_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_SPRITE_CACHE_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_SPRITE_CACHE_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_SPRITE_CACHE_LOGICAL_PAGE + 3)
		; flat cache undo   NOTE: we just call it with seven params to set everything up for sprites
	dw	_EPR(11)
	dw	_EPR(12)
	dw	_EPR(RENDER_7800_PAGE)
	dw	_EPR(RENDER_7C00_PAGE)
		;masked
	dw	_EPR(FIRST_EXTRA_MASKED_DATA_PAGE)
	dw	_EPR(FIRST_EXTRA_MASKED_DATA_PAGE+1)
	dw	_EPR(PHYSICS_RENDER_9800_PAGE)  ; put colormaps where vissprites used to be?
		;render 9000 to 6000
	dw	_EPR(11)
	dw	_EPR(12)
		; palette
	dw	_NPR(PAGE_8000_OFFSET)
	dw	_NPR(PAGE_8400_OFFSET)
	dw	_NPR(PAGE_8800_OFFSET)
	dw	_NPR(PAGE_8C00_OFFSET)  ; SCREEN0_LOGICAL_PAGE
	dw	_EPR(PALETTE_LOGICAL_PAGE)
	; menu 
	dw	_NPR(PAGE_5000_OFFSET)
	dw	_NPR(PAGE_5400_OFFSET)
	dw	_NPR(PAGE_5800_OFFSET)
	dw	_EPR(FIRST_MENU_GRAPHICS_LOGICAL_PAGE + 0)
	dw	_NPR(PAGE_6000_OFFSET) 				  	    ; STRINGS_LOGICAL_PAGE
	dw	_EPR(FIRST_MENU_GRAPHICS_LOGICAL_PAGE + 1)
	dw	_NPR(PAGE_6800_OFFSET)  				  
	dw	_NPR(PAGE_6C00_OFFSET)

	; intermission 
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 4)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 5)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 6)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 7)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 0)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 1)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 2)
	dw	_EPR(FIRST_INTERMISSION_GRAPHICS_LOGICAL_PAGE + 3)
	; wipe/intermission, shared pages
	dw	_NPR(PAGE_8000_OFFSET)   ; SCREEN0_LOGICAL_PAGE
	dw	_NPR(PAGE_8400_OFFSET)
	dw	_NPR(PAGE_8800_OFFSET)
	dw	_NPR(PAGE_8C00_OFFSET)
		; wipe start
	dw	_EPR(SCREEN1_LOGICAL_PAGE+0)
	dw	_EPR(SCREEN1_LOGICAL_PAGE+1)
	dw	_EPR(SCREEN1_LOGICAL_PAGE+2)
	dw	_EPR(SCREEN1_LOGICAL_PAGE+3)
	dw	_EPR(SCREEN3_LOGICAL_PAGE+0)
	dw	_EPR(SCREEN3_LOGICAL_PAGE+1)  ; shared with visplanes
	dw	_EPR(SCREEN3_LOGICAL_PAGE+2)  ; shared with visplanes
	dw	_EPR(SCREEN3_LOGICAL_PAGE+3)  ; shared with visplanes
	dw	_EPR(SCREEN2_LOGICAL_PAGE+0)
	dw	_EPR(SCREEN2_LOGICAL_PAGE+1)
	dw	_EPR(SCREEN2_LOGICAL_PAGE+2)
	dw	_EPR(SCREEN2_LOGICAL_PAGE+3)
	dw	_EPR(EMS_VISPLANE_EXTRA_PAGE)
	dw	_NPR(PAGE_9400_OFFSET)
	dw	_NPR(PAGE_9800_OFFSET)
