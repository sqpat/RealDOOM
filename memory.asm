...
; 430   43C is LUMPINFO_SEGMENT_PTR
dw  SECTORS_SEGMENT, LINES_PHYSICS_SEGMENT, VERTEXES_SEGMENT, LINEFLAGSLIST_SEGMENT, SEENLINES_6800_SEGMENT, SIDES_SEGMENT, 0D800h, 00
; 440
dw  00, 00, 00, 00, 00, 00, 00, 00
; UNUSED NOW
; 450
...
dw  00, 00, 00, 00, 00, 00, 00, 00
dw  00, 00, 00, 00, 00, 00, 00, 00
; 690  ; 694 = _spritewidths_segment_ptr
dw  00, 00, SPRITEWIDTHS_SEGMENT, 00, 00, 00, 00, 00
; 6A0 
dw  00, 00, 00, 00, 00, 00, 00, 00
; 6B0 
dw  00, 00, 00, 00, 00, 00, 00, 00
...
;pageswapargs
	...
	_NPR PAGE_9000_OFFSET 		 					PAGE_9000_OFFSET ;segs physics
