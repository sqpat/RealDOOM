...
SEGMENT R_MASK16_TEXT USE16 PARA PUBLIC 'CODE'
ASSUME  CS:R_MASK16_TEXT
...
_fuzzpos:
dw  (OFFSET _fuzzoffset) - (OFFSET R_MASK16_STARTMARKER_)
...
push es
mov  es, bx
mov  si, word ptr cs:[_fuzzpos - OFFSET R_MASK16_STARTMARKER_]	; note this is always the byte offset - no shift conversion necessary
...
cmp  si, ((OFFSET _fuzzoffset) - (OFFSET R_MASK16_STARTMARKER_)) +  (SIZE_FUZZTABLE * 2) ; word size
jl   fuzzpos_ok
...
mov  word ptr word ptr cs:[_fuzzpos - OFFSET R_MASK16_STARTMARKER_], si
...
zero_out_fuzzpos:
mov   si, (OFFSET _fuzzoffset) - (OFFSET R_MASK16_STARTMARKER_)
loop  draw_one_fuzzpixel
...
mov   al, byte ptr cs:[SELFMODIFY_MASKED_multi_set_colormap_index_jump - OFFSET R_MASK16_STARTMARKER_]
mov   byte ptr cs:[SELFMODIFY_MASKED_set_colormap_index_jump - OFFSET R_MASK16_STARTMARKER_], al
...
mov   si, word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_hi_1+1 - OFFSET R_MASK16_STARTMARKER_]
mov   bx, word ptr cs:[SELFMODIFY_MASKED_set_dc_iscale_lo+1 - OFFSET R_MASK16_STARTMARKER_]
mov   cx, word ptr cs:[SELFMODIFY_MASKED_set_dc_iscale_hi+1 - OFFSET R_MASK16_STARTMARKER_]


push  bp
mov   bp, word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_lo_1+1 - OFFSET R_MASK16_STARTMARKER_]
...
add   al, 0
mov   byte ptr cs:[SELFMODIFY_MASKED_set_bx_to_lookup+1 - OFFSET R_MASK16_STARTMARKER_], al
...
mov   byte ptr cs:[SELFMODIFY_MASKED_multi_set_colormap_index_jump - OFFSET R_MASK16_STARTMARKER_], al
...
mov   dh, dl
mov   dl, ah
mov   word ptr cs:[SELFMODIFY_MASKED_set_dc_iscale_lo+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_set_dc_iscale_hi+1 - OFFSET R_MASK16_STARTMARKER_], dx
...
mov   cx, es
; write this ahead
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_lo_1 + 1 - OFFSET R_MASK16_STARTMARKER_], bx
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_hi_1 + 1 - OFFSET R_MASK16_STARTMARKER_], cx
...
mov   word ptr cs:[SELFMODIFY_MASKED_set_ax_to_dc_x_base4+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_set_ax_to_dc_x_base4_shadow+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   byte ptr cs:[SELFMODIFY_MASKED_set_bx_to_xoffset+1 - OFFSET R_MASK16_STARTMARKER_], 0
mov   byte ptr cs:[SELFMODIFY_MASKED_set_bx_to_xoffset_shadow+1 - OFFSET R_MASK16_STARTMARKER_], 0
...
inc   word ptr cs:[SELFMODIFY_MASKED_set_ax_to_dc_x_base4+1 - OFFSET R_MASK16_STARTMARKER_]
inc   byte ptr cs:[SELFMODIFY_MASKED_set_bx_to_xoffset+1 - OFFSET R_MASK16_STARTMARKER_]
...
inc   word ptr cs:[SELFMODIFY_MASKED_set_ax_to_dc_x_base4_shadow+1 - OFFSET R_MASK16_STARTMARKER_]
inc   byte ptr cs:[SELFMODIFY_MASKED_set_bx_to_xoffset_shadow+1 - OFFSET R_MASK16_STARTMARKER_]
mov   ax, word ptr ds:[si + 01Eh]
add   word ptr [bp - 4], ax
mov   ax, word ptr ds:[si + 020h]
adc   word ptr [bp - 2], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_x1_field_1+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_x1_field_2+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_x1_field_3+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_cmp_to_x2+1 - OFFSET R_MASK16_STARTMARKER_], cx
...
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_02+1 - OFFSET R_MASK16_STARTMARKER_], ax
inc   si
inc   si
lods  word ptr ds:[si]  ; si 8 after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_06+1 - OFFSET R_MASK16_STARTMARKER_], ax
lods  word ptr ds:[si]  ; si A after
add   si, 4
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_08+2 - OFFSET R_MASK16_STARTMARKER_], ax
lods  word ptr ds:[si]  ; si 0x10 after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_0E+1 - OFFSET R_MASK16_STARTMARKER_], ax
lods  word ptr ds:[si]  ; si 0x12 after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_10+1 - OFFSET R_MASK16_STARTMARKER_], ax
add   si, 4
lods  word ptr ds:[si]  ; si 0x18 after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_16+4 - OFFSET R_MASK16_STARTMARKER_], ax
lods  word ptr ds:[si]  ; si 0x1A after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_18+4 - OFFSET R_MASK16_STARTMARKER_], ax
lods  word ptr ds:[si]  ; si 0x1C after
mov   word ptr cs:[SELFMODIFY_MASKED_dsp_1A+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_siderender_00+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   ax, word ptr ds:[bx+2] 
mov   word ptr cs:[SELFMODIFY_MASKED_siderender_02+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_texnum_1+1 - OFFSET R_MASK16_STARTMARKER_], si
mov   word ptr cs:[SELFMODIFY_MASKED_texnum_2+1 - OFFSET R_MASK16_STARTMARKER_], si
mov   word ptr cs:[SELFMODIFY_MASKED_texnum_3+3 - OFFSET R_MASK16_STARTMARKER_], si
...
mov   word ptr cs:[SELFMODIFY_MASKED_maskedpostofs_1  +3 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_maskedpostofs_2+3 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_lookup_1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_lookup_2 - OFFSET R_MASK16_STARTMARKER_], bx
...
mov   byte ptr cs:[SELFMODIFY_MASKED_add_vertex_field - OFFSET R_MASK16_STARTMARKER_], al
...
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_lo_1 + 1 - OFFSET R_MASK16_STARTMARKER_], dx
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_lo_2 + 1 - OFFSET R_MASK16_STARTMARKER_], dx
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_lo_3 + 1 - OFFSET R_MASK16_STARTMARKER_], dx
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_hi_1 + 1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_hi_2 + 1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr cs:[SELFMODIFY_MASKED_dc_texturemid_hi_3 + 1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   byte ptr cs:[SELFMODIFY_MASKED_multi_set_colormap_index_jump - OFFSET R_MASK16_STARTMARKER_], 0
jmp   colormap_set
...
mov   word ptr cs:[SELFMODIFY_MASKED_set_walllights+2 - OFFSET R_MASK16_STARTMARKER_], ax      ; store lights
...
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_lo_1+1 - OFFSET R_MASK16_STARTMARKER_], bx		; rw_scalestep
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_lo_2+5 - OFFSET R_MASK16_STARTMARKER_], bx		; rw_scalestep
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_lo_3+5 - OFFSET R_MASK16_STARTMARKER_], bx		; rw_scalestep
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_hi_1+1 - OFFSET R_MASK16_STARTMARKER_], cx		; rw_scalestep
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_hi_2+5 - OFFSET R_MASK16_STARTMARKER_], cx		; rw_scalestep
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_hi_3+5 - OFFSET R_MASK16_STARTMARKER_], cx		; rw_scalestep
...
and   ax, 01000h
mov   word ptr cs:[SELFMODIFY_MASKED_dc_x_base4+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_lo+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   ax, word ptr ds:[_spryscale + 2]
mov   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_hi+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_shift_lo_1+2 - OFFSET R_MASK16_STARTMARKER_], ax		; rw_scalestep_shift
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_shift_lo_2+4 - OFFSET R_MASK16_STARTMARKER_], ax		; rw_scalestep_shift
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_shift_hi_1+2 - OFFSET R_MASK16_STARTMARKER_], dx		; rw_scalestep_shift
mov   word ptr cs:[SELFMODIFY_MASKED_rw_scalestep_shift_hi_2+4 - OFFSET R_MASK16_STARTMARKER_], dx		; rw_scalestep_shift
...
mov   word ptr cs:[SELFMODIFY_MASKED_sprtopscreen_lo+4 - OFFSET R_MASK16_STARTMARKER_], ax	  ; sprtopscreen_step
mov   word ptr cs:[SELFMODIFY_MASKED_sprtopscreen_hi+4 - OFFSET R_MASK16_STARTMARKER_], dx	  ; sprtopscreen_step
...
sub   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_lo+1 - OFFSET R_MASK16_STARTMARKER_], 01000h
SELFMODIFY_MASKED_rw_scalestep_hi_2:
sbb   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_hi+1 - OFFSET R_MASK16_STARTMARKER_], 01000h
...
mov   word ptr cs:[SELF_MODIFY_MASKED_xoffset+1 - OFFSET R_MASK16_STARTMARKER_], di
...
add   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_lo+1 - OFFSET R_MASK16_STARTMARKER_], 01000h
SELFMODIFY_MASKED_rw_scalestep_hi_3:
adc   word ptr cs:[SELFMODIFY_MASKED_get_basespryscale_hi+1 - OFFSET R_MASK16_STARTMARKER_], 01000h
...
sal   si, 1
mov   dx, word ptr cs:[si + _pagesegments - OFFSET R_MASK16_STARTMARKER_]
...
mov       es, dx
lodsw
mov       word ptr cs:[SELFMODIFY_loadspritecolumn_width_check+1 - OFFSET R_MASK16_STARTMARKER_],  ax  ; patchwidth
stosw
movsw
movsw
movsw
...
dec       word ptr cs:[SELFMODIFY_loadspritecolumn_width_check+1 - OFFSET R_MASK16_STARTMARKER_]
...
mov   byte ptr cs:[SELFMODIFY_MASKED_set_al_to_silhouette+1 - OFFSET R_MASK16_STARTMARKER_],  al
...
and   byte ptr cs:[SELFMODIFY_MASKED_set_al_to_silhouette+1 - OFFSET R_MASK16_STARTMARKER_], 0FEh  
...
PROC R_DrawMasked16_ FAR
PUBLIC R_DrawMasked16_
...
mov       byte ptr cs:[SELFMODIFY_MASKED_loop_compare_instruction+1 - OFFSET R_MASK16_STARTMARKER_], al ; store count
mov       dx, ax
mov       cx, 014h
lea       di, [bp - 034h]
mov       ax, ds
...
mov       byte ptr cs:[SELFMODIFY_MASKED_set_al_to_loop_counter+1 - OFFSET R_MASK16_STARTMARKER_], 0  ; zero loop counter
...
inc       byte ptr cs:[SELFMODIFY_MASKED_set_al_to_loop_counter+1 - OFFSET R_MASK16_STARTMARKER_] ; update loop counter
...
MOV  ES, SI
MOV  SI, DX
MOV  word ptr cs:[_selfmodify_restore_original_ax- OFFSET R_MASK16_STARTMARKER_+1], AX
MUL  BX
MOV  word ptr cs:[_selfmodify_restore_dx- OFFSET R_MASK16_STARTMARKER_+1], DX
MOV  AX, SI
MUL  CX
XCHG AX, SI
CWD
...
PROC R_WriteBackViewConstantsMasked16_ FAR
PUBLIC R_WriteBackViewConstantsMasked16_ 
...
mov      word ptr ds:[SELFMODIFY_MASKED_detailshift_2_minus_16_bit_shift- OFFSET R_MASK16_STARTMARKER_+0], ax
mov      word ptr ds:[SELFMODIFY_MASKED_detailshift_2_minus_16_bit_shift- OFFSET R_MASK16_STARTMARKER_+2], ax
mov      word ptr ds:[SELFMODIFY_MASKED_multi_detailshift_2_minus_16_bit_shift- OFFSET R_MASK16_STARTMARKER_+0], ax
mov      word ptr ds:[SELFMODIFY_MASKED_multi_detailshift_2_minus_16_bit_shift- OFFSET R_MASK16_STARTMARKER_+2], ax
...
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_1+2 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_2+4 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_3+1 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_4+2 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_5+4 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_6+1 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_7+4 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_8+2 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftitercount_9+1 - OFFSET R_MASK16_STARTMARKER_], al


mov   ax, word ptr ss:[_detailshiftandval]
mov   word ptr ds:[SELFMODIFY_MASKED_detailshiftandval_1+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr ds:[SELFMODIFY_MASKED_detailshiftandval_2+1 - OFFSET R_MASK16_STARTMARKER_], ax


mov   al, byte ptr ss:[_detailshift+1]
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftplus1_1+1 - OFFSET R_MASK16_STARTMARKER_], al
add   al, _quality_port_lookup
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftplus1_2+2 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftplus1_3+2 - OFFSET R_MASK16_STARTMARKER_], al
mov   byte ptr ds:[SELFMODIFY_MASKED_detailshiftplus1_4+2 - OFFSET R_MASK16_STARTMARKER_], al

mov   ax, word ptr ss:[_viewheight]
mov   word ptr ds:[SELFMODIFY_MASKED_viewheight_1+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr ds:[SELFMODIFY_MASKED_viewheight_2+1 - OFFSET R_MASK16_STARTMARKER_], ax
...
PROC R_WriteBackMaskedFrameConstants16_ FAR
PUBLIC R_WriteBackMaskedFrameConstants16_ 
...
mov   word ptr ds:[SELFMODIFY_MASKED_centery_1+3 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr ds:[SELFMODIFY_MASKED_centery_2+1 - OFFSET R_MASK16_STARTMARKER_], ax

mov   ax, word ptr ss:[_viewz+0]
mov   word ptr ds:[SELFMODIFY_MASKED_viewz_lo_1+2 - OFFSET R_MASK16_STARTMARKER_], ax
mov   ax, word ptr ss:[_viewz+2]
mov   word ptr ds:[SELFMODIFY_MASKED_viewz_hi_1+1 - OFFSET R_MASK16_STARTMARKER_], ax

mov   ax, word ptr ss:[_destview+0]
mov   word ptr ds:[SELFMODIFY_MASKED_destview_lo_1+2 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr ds:[SELFMODIFY_MASKED_destview_lo_2+1 - OFFSET R_MASK16_STARTMARKER_], ax
mov   word ptr ds:[SELFMODIFY_MASKED_destview_lo_3+1 - OFFSET R_MASK16_STARTMARKER_], ax

mov   ax, word ptr ss:[_destview+2]
mov   word ptr ds:[SELFMODIFY_MASKED_destview_hi_1+1 - OFFSET R_MASK16_STARTMARKER_], ax

mov   al, byte ptr ss:[_extralight]
mov   byte ptr ds:[SELFMODIFY_MASKED_extralight_1+1 - OFFSET R_MASK16_STARTMARKER_], al
...
; nop 
mov      ax, 0c089h 
mov      word ptr ds:[SELFMODIFY_MASKED_fixedcolormap_1 - OFFSET R_MASK16_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_MASKED_fixedcolormap_2 - OFFSET R_MASK16_STARTMARKER_], ax
...
mov   byte ptr ds:[SELFMODIFY_MASKED_fixedcolormap_3+5 - OFFSET R_MASK16_STARTMARKER_], al
...
PROC R_MASK16_ENDMARKER_ FAR
PUBLIC R_MASK16_ENDMARKER_ 
ENDP
