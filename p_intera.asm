...
dw give_ammo_case_0, give_ammo_case_1, give_ammo_case_2, give_ammo_case_3
...
mov    si, bx
add    si, bx
mov    ax, word ptr [si + _player + PLAYER_T.player_ammo]
cmp    ax, word ptr [si + _player + PLAYER_T.player_maxammo]
je     label_1
test   dx, dx
je     label_2
mov    al, byte ptr [bx + _clipammo]
cbw   
mov    bx, ax
mov    ax, dx
imul   bx
...
xor    bh, bh
add    bx, bx
mov    ax, word ptr [bx + _player + PLAYER_T.player_ammo]
mov    si, ax
add    si, dx
mov    word ptr [bx + _player + PLAYER_T.player_ammo], si
cmp    si, word ptr [bx + _player + PLAYER_T.player_maxammo]
jle    label_7
mov    dx, word ptr [bx + _player + PLAYER_T.player_maxammo]
mov    word ptr [bx + _player + PLAYER_T.player_ammo], dx
label_7:
test   ax, ax
...
cmp    byte ptr [bx], 0
jne    exit_giveammo_ret_1
mov    bx, _player + PLAYER_T.player_weaponowned + WP_CHAINGUN
cmp    byte ptr [bx], 0
je     label_13
...
jne    label_10
label_9:
mov    bx, _player + PLAYER_T.player_weaponowned + WP_SHOTGUN
cmp    byte ptr [bx], 0
...
jne    label_15
label_14:
mov    bx, _player + PLAYER_T.player_weaponowned + WP_PLASMA
cmp    byte ptr [bx], 0
je     exit_giveammo_ret_1
mov    bx, _player + PLAYER_T.player_pendingweapon
mov    byte ptr [bx], 5
...
cmp    byte ptr [bx], 0
jne    exit_giveammo_ret_1
mov    bx, _player + PLAYER_T.player_weaponowned + WP_MISSILE
cmp    byte ptr [bx], 0
jne    label_8
...
0x00000000000031ff:  80 BC 58 08 05          cmp    byte ptr [si + 0x858], 5
0x0000000000003204:  74 31                   je     0x3237
0x0000000000003206:  84 C0                   test   al, al
0x0000000000003208:  74 22                   je     0x322c
0x000000000000320a:  8A 94 58 08             mov    dl, byte ptr [si + 0x858]
...
0x000000000000321c:  80 BC 02 08 00          cmp    byte ptr [si + _player + PLAYER_T.player_weaponowned], 0
...
0x000000000000322c:  8A 94 58 08             mov    dl, byte ptr [si + 0x858]
...
0x000000000000323b:  C6 84 02 08 01          mov    byte ptr [si + _player + PLAYER_T.player_weaponowned], 1
0x0000000000003240:  BE 01 08                mov    si, _player + PLAYER_T.player_pendingweapon
0x0000000000003243:  88 1C                   mov    byte ptr [si], bl
...
0x000000000000324f:  83 3F 64                cmp    word ptr [bx], 0x64
0x0000000000003252:  7D 1D                   jge    0x3271
0x0000000000003254:  01 07                   add    word ptr [bx], ax
0x0000000000003256:  83 3F 64                cmp    word ptr [bx], 0x64
0x0000000000003259:  7E 04                   jle    0x325f
0x000000000000325b:  C7 07 64 00             mov    word ptr [bx], 0x64
0x000000000000325f:  BE EC 06                mov    si, 0x6ec
0x0000000000003262:  BB E8 07                mov    bx, 0x7e8
0x0000000000003265:  8B 34                   mov    si, word ptr [si]
0x0000000000003267:  8B 07                   mov    ax, word ptr [bx]
0x0000000000003269:  89 44 1C                mov    word ptr [si + 0x1c], ax
...
0x000000000000327e:  3B 17                   cmp    dx, word ptr [bx]
...
0x000000000000328a:  88 07                   mov    byte ptr [bx], al
0x000000000000328c:  BB EA 07                mov    bx, 0x7ea
0x000000000000328f:  B0 01                   mov    al, 1
0x0000000000003291:  89 17                   mov    word ptr [bx], dx
...
0x000000000000329c:  80 BF FA 07 00          cmp    byte ptr [bx + 0x7fa], 0
...
0x00000000000032a9:  C6 04 06                mov    byte ptr [si], 6
0x00000000000032ac:  C6 87 FA 07 01          mov    byte ptr [bx + 0x7fa], 1
...
0x00000000000032d2:  83 BF EE 07 00          cmp    word ptr [bx + 0x7ee], 0
...
0x00000000000032e0:  C7 87 EE 07 1A 04       mov    word ptr [bx + 0x7ee], 0x41a
0x00000000000032e6:  5E                      pop    si
0x00000000000032e7:  5B                      pop    bx
0x00000000000032e8:  CB                      retf   
0x00000000000032e9:  C7 87 EE 07 34 08       mov    word ptr [bx + 0x7ee], 0x834
0x00000000000032ef:  BB 30 07                mov    bx, 0x730
0x00000000000032f2:  C4 37                   les    si, ptr [bx]
...
0x0000000000003300:  C7 87 EE 07 68 10       mov    word ptr [bx + 0x7ee], 0x1068
0x0000000000003306:  5E                      pop    si
0x0000000000003307:  5B                      pop    bx
0x0000000000003308:  CB                      retf   
0x0000000000003309:  B0 01                   mov    al, 1
0x000000000000330b:  C7 87 EE 07 34 08       mov    word ptr [bx + 0x7ee], 0x834
...
0x000000000000331c:  C7 87 EE 07 01 00       mov    word ptr [bx + 0x7ee], 1
0x0000000000003322:  5E                      pop    si
0x0000000000003323:  5B                      pop    bx
0x0000000000003324:  CB                      retf   
; table

0x0000000000003326:  08 34                   or     byte ptr [si], dh
...
0x000000000000334c:  D8 34                   fdiv   dword ptr [si]
0x000000000000334e:  19 36 34 36             sbb    word ptr [0x3634], si
...
0x00000000000033d4:  3B 5D 0C                cmp    bx, word ptr [di + 0xc]
0x00000000000033d7:  7F 63                   jg     0x343c
0x00000000000033d9:  75 05                   jne    0x33e0
0x00000000000033db:  3B 55 0A                cmp    dx, word ptr [di + 0xa]
...
0x00000000000033e8:  83 7D 1C 00             cmp    word ptr [di + 0x1c], 0
...
0x0000000000003415:  C7 07 18 00             mov    word ptr [bx], 0x18
...
0x0000000000003422:  FF 07                   inc    word ptr [bx]
...
0x0000000000003434:  80 07 06                add    byte ptr [bx], 6
...
0x0000000000003459:  C7 07 19 00             mov    word ptr [bx], 0x19
0x000000000000345d:  EB BA                   jmp    0x3419
0x000000000000345f:  BB E8 07                mov    bx, 0x7e8
0x0000000000003462:  FF 07                   inc    word ptr [bx]
0x0000000000003464:  81 3F C8 00             cmp    word ptr [bx], 0xc8
0x0000000000003468:  7F 16                   jg     0x3480
0x000000000000346a:  BB EC 06                mov    bx, 0x6ec
0x000000000000346d:  BE E8 07                mov    si, 0x7e8
0x0000000000003470:  8B 1F                   mov    bx, word ptr [bx]
0x0000000000003472:  8B 04                   mov    ax, word ptr [si]
0x0000000000003474:  89 47 1C                mov    word ptr [bx + 0x1c], ax
0x0000000000003477:  BB 24 08                mov    bx, 0x824
0x000000000000347a:  C7 07 1A 00             mov    word ptr [bx], 0x1a
0x000000000000347e:  EB 99                   jmp    0x3419
0x0000000000003480:  C7 07 C8 00             mov    word ptr [bx], 0xc8
0x0000000000003484:  EB E4                   jmp    0x346a
0x0000000000003486:  BB EA 07                mov    bx, 0x7ea
0x0000000000003489:  FF 07                   inc    word ptr [bx]
0x000000000000348b:  81 3F C8 00             cmp    word ptr [bx], 0xc8
0x000000000000348f:  7F 15                   jg     0x34a6
0x0000000000003491:  BB EC 07                mov    bx, 0x7ec
0x0000000000003494:  80 3F 00                cmp    byte ptr [bx], 0
0x0000000000003497:  75 03                   jne    0x349c
0x0000000000003499:  C6 07 01                mov    byte ptr [bx], 1
0x000000000000349c:  BB 24 08                mov    bx, 0x824
0x000000000000349f:  C7 07 1B 00             mov    word ptr [bx], 0x1b
0x00000000000034a3:  E9 73 FF                jmp    0x3419
0x00000000000034a6:  C7 07 C8 00             mov    word ptr [bx], 0xc8
0x00000000000034aa:  EB E5                   jmp    0x3491
0x00000000000034ac:  BB E8 07                mov    bx, 0x7e8
0x00000000000034af:  83 07 64                add    word ptr [bx], 0x64
0x00000000000034b2:  81 3F C8 00             cmp    word ptr [bx], 0xc8
0x00000000000034b6:  7F 1A                   jg     0x34d2
0x00000000000034b8:  BB EC 06                mov    bx, 0x6ec
0x00000000000034bb:  BE E8 07                mov    si, 0x7e8
0x00000000000034be:  8B 1F                   mov    bx, word ptr [bx]
0x00000000000034c0:  8B 04                   mov    ax, word ptr [si]
0x00000000000034c2:  89 47 1C                mov    word ptr [bx + 0x1c], ax
0x00000000000034c5:  BB 24 08                mov    bx, 0x824
0x00000000000034c8:  B9 5D 00                mov    cx, 0x5d
0x00000000000034cb:  C7 07 1E 00             mov    word ptr [bx], 0x1e
0x00000000000034cf:  E9 47 FF                jmp    0x3419
0x00000000000034d2:  C7 07 C8 00             mov    word ptr [bx], 0xc8
0x00000000000034d6:  EB E0                   jmp    0x34b8
0x00000000000034d8:  BB EB 02                mov    bx, 0x2eb
0x00000000000034db:  80 3F 00                cmp    byte ptr [bx], 0
...
0x00000000000034e9:  C7 07 C8 00             mov    word ptr [bx], 0xc8
0x00000000000034ed:  8B 34                   mov    si, word ptr [si]
0x00000000000034ef:  8B 07                   mov    ax, word ptr [bx]
0x00000000000034f1:  BB 24 08                mov    bx, 0x824
0x00000000000034f4:  89 44 1C                mov    word ptr [si + 0x1c], ax
0x00000000000034f7:  B8 02 00                mov    ax, 2
0x00000000000034fa:  B9 5D 00                mov    cx, 0x5d
0x00000000000034fd:  E8 76 FD                call   0x3276
0x0000000000003500:  C7 07 2B 00             mov    word ptr [bx], 0x2b
0x0000000000003504:  E9 12 FF                jmp    0x3419
0x0000000000003507:  BB FA 07                mov    bx, 0x7fa
0x000000000000350a:  80 3F 00                cmp    byte ptr [bx], 0
0x000000000000350d:  75 07                   jne    0x3516
0x000000000000350f:  BB 24 08                mov    bx, 0x824
0x0000000000003512:  C7 07 1F 00             mov    word ptr [bx], 0x1f
...
0x0000000000003521:  80 3F 00                cmp    byte ptr [bx], 0
0x0000000000003524:  75 05                   jne    0x352b
0x0000000000003526:  BB 24 08                mov    bx, 0x824
0x0000000000003529:  89 0F                   mov    word ptr [bx], cx
...
0x0000000000003537:  80 3F 00                cmp    byte ptr [bx], 0
0x000000000000353a:  75 07                   jne    0x3543
0x000000000000353c:  BB 24 08                mov    bx, 0x824
0x000000000000353f:  C7 07 21 00             mov    word ptr [bx], 0x21
...
0x000000000000354f:  80 3F 00                cmp    byte ptr [bx], 0
0x0000000000003552:  75 07                   jne    0x355b
0x0000000000003554:  BB 24 08                mov    bx, 0x824
0x0000000000003557:  C7 07 22 00             mov    word ptr [bx], 0x22
...
0x0000000000003567:  80 3F 00                cmp    byte ptr [bx], 0
0x000000000000356a:  75 07                   jne    0x3573
0x000000000000356c:  BB 24 08                mov    bx, 0x824
0x000000000000356f:  C7 07 23 00             mov    word ptr [bx], 0x23
...
0x000000000000357f:  80 3F 00                cmp    byte ptr [bx], 0
0x0000000000003582:  75 07                   jne    0x358b
0x0000000000003584:  BB 24 08                mov    bx, 0x824
0x0000000000003587:  C7 07 24 00             mov    word ptr [bx], 0x24
...
0x00000000000035a4:  C7 07 1C 00             mov    word ptr [bx], 0x1c
...
0x00000000000035b8:  C7 07 1D 00             mov    word ptr [bx], 0x1d
...
0x00000000000035cf:  C7 07 25 00             mov    word ptr [bx], 0x25
...
0x00000000000035e4:  C7 07 26 00             mov    word ptr [bx], 0x26
0x00000000000035e8:  BB 00 08                mov    bx, _player + PLAYER_T.player_readyweapon
0x00000000000035eb:  80 3F 00                cmp    byte ptr [bx], 0
...
0x00000000000035f9:  88 37                   mov    byte ptr [bx], dh
...
0x0000000000003612:  C7 07 27 00             mov    word ptr [bx], 0x27
...
0x000000000000362d:  C7 07 28 00             mov    word ptr [bx], 0x28
...
0x0000000000003645:  C7 07 29 00             mov    word ptr [bx], 0x29
...
0x000000000000365d:  C7 07 2A 00             mov    word ptr [bx], 0x2a
...
0x0000000000003676:  C7 07 2C 00             mov    word ptr [bx], 0x2c
...
0x0000000000003693:  C7 07 2D 00             mov    word ptr [bx], 0x2d
...
0x00000000000036ad:  C7 07 2E 00             mov    word ptr [bx], 0x2e
...
0x00000000000036c4:  C7 07 2F 00             mov    word ptr [bx], 0x2f
...
0x00000000000036db:  C7 07 30 00             mov    word ptr [bx], 0x30
...
0x00000000000036f2:  C7 07 31 00             mov    word ptr [bx], 0x31
...
0x0000000000003708:  C7 07 32 00             mov    word ptr [bx], 0x32
...
0x000000000000371f:  C7 07 33 00             mov    word ptr [bx], 0x33
0x0000000000003723:  E9 F3 FC                jmp    0x3419
0x0000000000003726:  BB 32 08                mov    bx, 0x832
0x0000000000003729:  80 3F 00                cmp    byte ptr [bx], 0
...
0x0000000000003739:  D1 A7 14 08             shl    word ptr [bx + _player + PLAYER_T.player_maxammo], 1
0x000000000000373d:  80 FA 04                cmp    dl, 4
0x0000000000003740:  7C EE                   jl     0x3730
0x0000000000003742:  BB 32 08                mov    bx, 0x832
0x0000000000003745:  C6 07 01                mov    byte ptr [bx], 1
...
0x000000000000375e:  C7 07 34 00             mov    word ptr [bx], 0x34
...
0x000000000000377a:  C7 07 35 00             mov    word ptr [bx], 0x35
...
0x0000000000003794:  C7 07 36 00             mov    word ptr [bx], 0x36
...
0x00000000000037ad:  C7 07 37 00             mov    word ptr [bx], 0x37
...
0x00000000000037c6:  C7 07 38 00             mov    word ptr [bx], 0x38
...
0x00000000000037df:  C7 07 39 00             mov    word ptr [bx], 0x39
...
0x00000000000037fc:  C7 07 3A 00             mov    word ptr [bx], 0x3a
...
0x0000000000003816:  C7 07 3B 00             mov    word ptr [bx], 0x3b
...
0x0000000000003858:  80 7C 1A 12             cmp    byte ptr [si + 0x1a], 0x12
...
0x000000000000386e:  D1 7C 0C                sar    word ptr [si + 0xc], 1
0x0000000000003871:  D1 5C 0A                rcr    word ptr [si + 0xa], 1
0x0000000000003874:  D1 7C 0C                sar    word ptr [si + 0xc], 1
0x0000000000003877:  D1 5C 0A                rcr    word ptr [si + 0xa], 1
0x000000000000387a:  85 FF                   test   di, di
0x000000000000387c:  74 06                   je     0x3884
0x000000000000387e:  80 7D 1A 00             cmp    byte ptr [di + 0x1a], 0
...
0x000000000000388e:  FF 05                   inc    word ptr [di]
0x0000000000003890:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x00000000000038a8:  3B 05                   cmp    ax, word ptr [di]
0x00000000000038aa:  75 25                   jne    0x38d1
0x00000000000038ac:  C6 06 35 20 01          mov    byte ptr [0x2035], 1
...
0x00000000000038bb:  A3 C4 1D                mov    word ptr [0x1dc4], ax
0x00000000000038be:  89 16 C6 1D             mov    word ptr [0x1dc6], dx
0x00000000000038c2:  26 8B 57 04             mov    dx, word ptr es:[bx + 4]
0x00000000000038c6:  26 8B 47 06             mov    ax, word ptr es:[bx + 6]
0x00000000000038ca:  89 16 C0 1D             mov    word ptr [0x1dc0], dx
0x00000000000038ce:  A3 C2 1D                mov    word ptr [0x1dc2], ax
0x00000000000038d1:  80 7C 1A 00             cmp    byte ptr [si + 0x1a], 0
...
0x0000000000003911:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003926:  28 44 1B                sub    byte ptr [si + 0x1b], al
0x0000000000003929:  8A 44 1B                mov    al, byte ptr [si + 0x1b]
0x000000000000392c:  3C 01                   cmp    al, 1
0x000000000000392e:  73 5E                   jae    0x398e
0x0000000000003930:  C6 44 1B 01             mov    byte ptr [si + 0x1b], 1
0x0000000000003934:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003941:  FF 74 04                push   word ptr [si + 4]
...
0x0000000000003967:  C4 1C                   les    bx, ptr [si]
...
0x0000000000003972:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x00000000000039ab:  39 39                   cmp    word ptr [bx + di], di
0x00000000000039ad:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039af:  3A 1F                   cmp    bl, byte ptr [bx]
0x00000000000039b1:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039b3:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039b5:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039b7:  3A 07                   cmp    al, byte ptr [bx]
0x00000000000039b9:  3A 07                   cmp    al, byte ptr [bx]
0x00000000000039bb:  3A 07                   cmp    al, byte ptr [bx]
0x00000000000039bd:  3A 1F                   cmp    bl, byte ptr [bx]
0x00000000000039bf:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039c1:  3A 1F                   cmp    bl, byte ptr [bx]
0x00000000000039c3:  3A FF                   cmp    bh, bh
0x00000000000039c5:  39 1F                   cmp    word ptr [bx], bx
0x00000000000039c7:  3A 0F                   cmp    cl, byte ptr [bx]
0x00000000000039c9:  3A 1F                   cmp    bl, byte ptr [bx]
0x00000000000039cb:  3A 07                   cmp    al, byte ptr [bx]
0x00000000000039cd:  3A 39                   cmp    bh, byte ptr [bx + di]
0x00000000000039cf:  3A 2F                   cmp    ch, byte ptr [bx]
0x00000000000039d1:  3A 2F                   cmp    ch, byte ptr [bx]
...
0x0000000000003a94:  83 7C 1C 00             cmp    word ptr [si + 0x1c], 0
...
0x0000000000003aa4:  80 7C 1A 00             cmp    byte ptr [si + 0x1a], 0
0x0000000000003aa8:  75 0A                   jne    0x3ab4
0x0000000000003aaa:  BB 31 01                mov    bx, 0x131
0x0000000000003aad:  80 3F 00                cmp    byte ptr [bx], 0
...
0x0000000000003b30:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003b4e:  3B 7C 1C                cmp    di, word ptr [si + 0x1c]
...
0x0000000000003bba:  01 44 0E                add    word ptr [si + 0xe], ax
0x0000000000003bbd:  B8 D6 31                mov    ax, 0x31d6
0x0000000000003bc0:  11 54 10                adc    word ptr [si + 0x10], dx
0x0000000000003bc3:  8B 56 F8                mov    dx, word ptr [bp - 8]
0x0000000000003bc6:  9A 03 5C A8 0A          lcall  0xaa8:0x5c03
0x0000000000003bcb:  01 44 12                add    word ptr [si + 0x12], ax
0x0000000000003bce:  11 54 14                adc    word ptr [si + 0x14], dx
0x0000000000003bd1:  80 7C 1A 00             cmp    byte ptr [si + 0x1a], 0
0x0000000000003bd5:  74 03                   je     0x3bda
0x0000000000003bd7:  E9 A0 00                jmp    0x3c7a
0x0000000000003bda:  8B 44 04                mov    ax, word ptr [si + 4]
0x0000000000003bdd:  C1 E0 04                shl    ax, 4
0x0000000000003be0:  89 C3                   mov    bx, ax
0x0000000000003be2:  81 C3 3E DE             add    bx, 0xde3e
0x0000000000003be6:  80 3F 0B                cmp    byte ptr [bx], 0xb
0x0000000000003be9:  75 0A                   jne    0x3bf5
0x0000000000003beb:  8B 44 1C                mov    ax, word ptr [si + 0x1c]
...
0x0000000000003c29:  3B 07                   cmp    ax, word ptr [bx]
0x0000000000003c2b:  7C 08                   jl     0x3c35
0x0000000000003c2d:  8B 07                   mov    ax, word ptr [bx]
0x0000000000003c2f:  BB EC 07                mov    bx, 0x7ec
0x0000000000003c32:  C6 07 00                mov    byte ptr [bx], 0
0x0000000000003c35:  BB EA 07                mov    bx, 0x7ea
0x0000000000003c38:  29 C7                   sub    di, ax
0x0000000000003c3a:  29 07                   sub    word ptr [bx], ax
0x0000000000003c3c:  BB E8 07                mov    bx, 0x7e8
0x0000000000003c3f:  29 3F                   sub    word ptr [bx], di
0x0000000000003c41:  83 3F 00                cmp    word ptr [bx], 0
...
0x0000000000003c59:  89 07                   mov    word ptr [bx], ax
0x0000000000003c5b:  8B 5E FA                mov    bx, word ptr [bp - 6]
0x0000000000003c5e:  83 7F 1C 00             cmp    word ptr [bx + 0x1c], 0
0x0000000000003c62:  7F 03                   jg     0x3c67
0x0000000000003c64:  E9 EC 00                jmp    0x3d53
0x0000000000003c67:  C6 06 35 20 00          mov    byte ptr [0x2035], 0
0x0000000000003c6c:  BB 28 08                mov    bx, 0x828
0x0000000000003c6f:  01 3F                   add    word ptr [bx], di
0x0000000000003c71:  83 3F 64                cmp    word ptr [bx], 0x64
0x0000000000003c74:  7E 04                   jle    0x3c7a
0x0000000000003c76:  C7 07 64 00             mov    word ptr [bx], 0x64
0x0000000000003c7a:  29 7C 1C                sub    word ptr [si + 0x1c], di
0x0000000000003c7d:  83 7C 1C 00             cmp    word ptr [si + 0x1c], 0
...
0x0000000000003c8b:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003ca8:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003cb8:  C6 44 24 00             mov    byte ptr [si + 0x24], 0
0x0000000000003cbc:  80 7C 25 00             cmp    byte ptr [si + 0x25], 0
...
0x0000000000003ccf:  80 7F 1A 03             cmp    byte ptr [bx + 0x1a], 3
...
0x0000000000003cdf:  89 44 22                mov    word ptr [si + 0x22], ax
0x0000000000003ce2:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
...
0x0000000000003ced:  C6 44 25 64             mov    byte ptr [si + 0x25], 0x64
...
0x0000000000003cfe:  3B 17                   cmp    dx, word ptr [bx]
...
0x0000000000003d06:  C7 44 16 00 00          mov    word ptr [si + 0x16], 0
0x0000000000003d0b:  C7 44 18 00 00          mov    word ptr [si + 0x18], 0
0x0000000000003d10:  8B 44 16                mov    ax, word ptr [si + 0x16]
0x0000000000003d13:  8B 54 18                mov    dx, word ptr [si + 0x18]
0x0000000000003d16:  89 44 12                mov    word ptr [si + 0x12], ax
0x0000000000003d19:  89 54 14                mov    word ptr [si + 0x14], dx
0x0000000000003d1c:  8B 54 12                mov    dx, word ptr [si + 0x12]
0x0000000000003d1f:  8B 44 14                mov    ax, word ptr [si + 0x14]
0x0000000000003d22:  89 54 0E                mov    word ptr [si + 0xe], dx
0x0000000000003d25:  89 44 10                mov    word ptr [si + 0x10], ax
0x0000000000003d28:  E9 79 FD                jmp    0x3aa4
0x0000000000003d2b:  EB 6F                   jmp    0x3d9c
0x0000000000003d2d:  89 C3                   mov    bx, ax
0x0000000000003d2f:  80 7F 1A 00             cmp    byte ptr [bx + 0x1a], 0
...
0x0000000000003d3b:  80 3F 07                cmp    byte ptr [bx], 7
...
0x0000000000003d4a:  C7 07 00 00             mov    word ptr [bx], 0
0x0000000000003d4e:  E9 F8 FE                jmp    0x3c49
0x0000000000003d51:  EB 56                   jmp    0x3da9
0x0000000000003d53:  80 3E 35 20 00          cmp    byte ptr [0x2035], 0
...
0x0000000000003d65:  C6 06 35 20 01          mov    byte ptr [0x2035], 1
0x0000000000003d6a:  26 8B 17                mov    dx, word ptr es:[bx]
0x0000000000003d6d:  26 8B 47 02             mov    ax, word ptr es:[bx + 2]
0x0000000000003d71:  89 16 C4 1D             mov    word ptr [0x1dc4], dx
0x0000000000003d75:  A3 C6 1D                mov    word ptr [0x1dc6], ax
0x0000000000003d78:  26 8B 47 04             mov    ax, word ptr es:[bx + 4]
0x0000000000003d7c:  26 8B 57 06             mov    dx, word ptr es:[bx + 6]
0x0000000000003d80:  A3 C0 1D                mov    word ptr [0x1dc0], ax
0x0000000000003d83:  89 16 C2 1D             mov    word ptr [0x1dc2], dx
...
0x0000000000003d9c:  80 7C 1A 03             cmp    byte ptr [si + 0x1a], 3
...
0x0000000000003db3:  8A 44 1A                mov    al, byte ptr [si + 0x1a]
