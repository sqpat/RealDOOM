...
void __far MARKER_SM_COLFUNC_set_destview_segment0();
void __far MARKER_SM_COLFUNC_jump_offset0();
...
void __far MARKER_SM_COLFUNC_subtract_centery24_normalstretch();
...
void __far MARKER_SM_COLFUNC_set_destview_segment24_normalstretch();
void __far MARKER_SM_COLFUNC_set_destview_segment24_noloop();
void __far MARKER_SM_COLFUNC_set_destview_segment24_noloopandstretch();
void __far MARKER_SM_COLFUNC_jump_offset24_normalstretch();
void __far MARKER_SM_COLFUNC_jump_offset24_noloop();
void __far MARKER_SM_COLFUNC_jump_offset24_noloopandstretch();
...
int16_t main ( int16_t argc,int8_t** argv )  { 
    ...
    fprintf(fp, "SELFMODIFY_COLFUNC_SUBTRACT_CENTERY24_OFFSET_NORMALSTRETCH = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_subtract_centery24_normalstretch) - FP_OFF(R_BSP24_STARTMARKER));
	...
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENT24_NORMALSTRETCH_OFFSET    = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segment24_normalstretch)  - FP_OFF(R_BSP24_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_JUMP_OFFSET24_NORMALSTRETCH_OFFSET             = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_jump_offset24_normalstretch)           - FP_OFF(R_BSP24_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENT24_NOLOOP_OFFSET    = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segment24_noloop)  - FP_OFF(R_BSP24_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_JUMP_OFFSET24_NOLOOP_OFFSET             = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_jump_offset24_noloop)           - FP_OFF(R_BSP24_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENT24_NOLOOPANDSTRETCH_OFFSET    = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segment24_noloopandstretch)  - FP_OFF(R_BSP24_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_JUMP_OFFSET24_NOLOOPANDSTRETCH_OFFSET             = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_jump_offset24_noloopandstretch)           - FP_OFF(R_BSP24_STARTMARKER));
    fprintf(fp, "SELFMODIFY_COLFUNC_SUBTRACT_CENTERY16_OFFSET        = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_subtract_centery16)      - FP_OFF(R_BSP16_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENT16_OFFSET    = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segment16)  - FP_OFF(R_BSP16_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_JUMP_OFFSET16_OFFSET             = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_jump_offset16)           - FP_OFF(R_BSP16_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENT0_OFFSET     = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segment0)   - FP_OFF(R_BSP0_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_JUMP_OFFSET0_OFFSET              = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_jump_offset0)            - FP_OFF(R_BSP0_STARTMARKER));
	fprintf(fp, "SELFMODIFY_COLFUNC_SET_DESTVIEW_SEGMENTFL_OFFSET    = 0%Xh\n", FP_OFF(MARKER_SM_COLFUNC_set_destview_segmentFL)  - FP_OFF(R_BSPFL_STARTMARKER));
