...
// #define NUM_TEXTURE_L1_CACHE_PAGES 10
...
#define LINES_SEGMENT_PTR		          (*((segment_t __near*)             (_NULL_OFFSET + 0x043C)))
...
#define W_CheckNumForNameFar_addr  		  (*((uint32_t __near*)              (_NULL_OFFSET + 0x078C)))
...
#define flatcache_nodes				      (((cache_node_t __near*)           (_NULL_OFFSET + 0x0970)))
