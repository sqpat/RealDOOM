...
0x0000000000007f54:  89 46 F6             mov       word ptr [bp - 0xa], ax
0x0000000000007f57:  8B 46 12             mov       ax, word ptr [bp + 0x12]
0x0000000000007f5a:  89 46 F2             mov       word ptr [bp - 0xe], ax
0x0000000000007f5d:  8B 46 14             mov       ax, word ptr [bp + 0x14]
0x0000000000007f60:  8B 76 16             mov       si, word ptr [bp + 0x16]
0x0000000000007f63:  89 46 F8             mov       word ptr [bp - 8], ax
0x0000000000007f66:  83 FE 0B             cmp       si, 0xb
0x0000000000007f69:  75 03                jne       0x7f6e
0x0000000000007f6b:  E9 29 01             jmp       0x8097
0x0000000000007f6e:  83 FE 02             cmp       si, 2
0x0000000000007f71:  74 F8                je        0x7f6b
0x0000000000007f73:  83 FE 03             cmp       si, 3
0x0000000000007f76:  74 F3                je        0x7f6b
0x0000000000007f78:  83 FE 04             cmp       si, 4
0x0000000000007f7b:  74 EE                je        0x7f6b
0x0000000000007f7d:  83 FE 01             cmp       si, 1
0x0000000000007f80:  75 03                jne       0x7f85
0x0000000000007f82:  E9 1B 01             jmp       0x80a0
0x0000000000007f85:  F6 46 FA 10          test      byte ptr [bp - 6], 0x10
0x0000000000007f89:  75 E0                jne       0x7f6b
0x0000000000007f8b:  A0 14 22             mov       al, byte ptr [0x2214]
0x0000000000007f8e:  84 C0                test      al, al
0x0000000000007f90:  74 03                je        0x7f95
0x0000000000007f92:  E9 1C 01             jmp       0x80b1
0x0000000000007f95:  B8 01 00             mov       ax, 1
0x0000000000007f98:  85 46 FA             test      word ptr [bp - 6], ax
0x0000000000007f9b:  74 CE                je        0x7f6b
0x0000000000007f9d:  31 C0                xor       ax, ax
0x0000000000007f9f:  31 D2                xor       dx, dx
0x0000000000007fa1:  BB C6 4C             mov       bx, 0x4cc6
0x0000000000007fa4:  8E C3                mov       es, bx
0x0000000000007fa6:  89 D3                mov       bx, dx
0x0000000000007fa8:  26 3B 37             cmp       si, word ptr es:[bx]
0x0000000000007fab:  74 03                je        0x7fb0
0x0000000000007fad:  E9 18 01             jmp       0x80c8
0x0000000000007fb0:  80 3E 2C 22 00       cmp       byte ptr [0x222c], 0
0x0000000000007fb5:  74 13                je        0x7fca
0x0000000000007fb7:  3D 12 00             cmp       ax, 0x12
0x0000000000007fba:  74 AF                je        0x7f6b
0x0000000000007fbc:  6B D0 0B             imul      dx, ax, 0xb
0x0000000000007fbf:  89 D3                mov       bx, dx
0x0000000000007fc1:  81 C3 69 C4          add       bx, 0xc469
0x0000000000007fc5:  F6 07 40             test      byte ptr ds:[bx], 0x40
0x0000000000007fc8:  75 A1                jne       0x7f6b
0x0000000000007fca:  8B 56 F2             mov       dx, word ptr [bp - 0xe]
0x0000000000007fcd:  89 56 F4             mov       word ptr [bp - 0xc], dx
0x0000000000007fd0:  6B D0 0B             imul      dx, ax, 0xb
0x0000000000007fd3:  8B 76 F6             mov       si, word ptr [bp - 0xa]
0x0000000000007fd6:  31 FF                xor       di, di
0x0000000000007fd8:  31 C9                xor       cx, cx
0x0000000000007fda:  89 D3                mov       bx, dx
0x0000000000007fdc:  81 C3 67 C4          add       bx, 0xc467
0x0000000000007fe0:  F6 47 01 01          test      byte ptr ds:[bx + 1], 1
0x0000000000007fe4:  75 03                jne       0x7fe9
0x0000000000007fe6:  E9 EE 00             jmp       0x80d7
0x0000000000007fe9:  BB FF FF             mov       bx, 0xffff
0x0000000000007fec:  BA FF 7F             mov       dx, 0x7fff
...
0x0000000000007ffc:  8B 4E F4             mov       cx, word ptr [bp - 0xc]
0x0000000000007fff:  BE 34 07             mov       si, 0x734
0x0000000000008002:  0E                   push      cs
0x0000000000008003:  E8 0E 02             call      0x8214
0x0000000000008006:  BB BA 01             mov       bx, 0x1ba
...
0x0000000000008013:  8D 76 10             lea       si, [bp + 0x10]
0x0000000000008016:  C1 E7 02             shl       di, 2
0x0000000000008019:  8B 1F                mov       bx, word ptr ds:[bx]
0x000000000000801b:  01 C7                add       di, ax
0x000000000000801d:  B8 EC 65             mov       ax, 0x65ec
0x0000000000008020:  01 FF                add       di, di
0x0000000000008022:  8E C0                mov       es, ax
0x0000000000008024:  A5                   movsw     word ptr es:[di], word ptr ds:[si]
0x0000000000008025:  A5                   movsw     word ptr es:[di], word ptr ds:[si]
0x0000000000008026:  A5                   movsw     word ptr es:[di], word ptr ds:[si]
0x0000000000008027:  A5                   movsw     word ptr es:[di], word ptr ds:[si]
0x0000000000008028:  A5                   movsw     word ptr es:[di], word ptr ds:[si]
0x0000000000008029:  8A 47 1B             mov       al, byte ptr ds:[bx + 0x1b]
0x000000000000802c:  89 56 FE             mov       word ptr [bp - 2], dx
0x000000000000802f:  84 C0                test      al, al
0x0000000000008031:  76 24                jbe       0x8057
0x0000000000008033:  3C F0                cmp       al, 0xf0
0x0000000000008035:  73 20                jae       0x8057
...
0x000000000000805a:  26 F6 47 16 40       test      byte ptr es:[bx + 0x16], 0x40
0x000000000000805f:  74 04                je        0x8065
0x0000000000008061:  FF 06 5E 1F          inc       word ptr [0x1f5e]
0x0000000000008065:  C4 5E FC             les       bx, ptr [bp - 4]
0x0000000000008068:  26 F6 47 16 80       test      byte ptr es:[bx + 0x16], 0x80
0x000000000000806d:  74 04                je        0x8073
...
0x0000000000008091:  F6 46 FA 08          test      byte ptr [bp - 6], 8
0x0000000000008095:  75 48                jne       0x80df
0x0000000000008097:  C9                   leave     
0x0000000000008098:  5F                   pop       di
0x0000000000008099:  5E                   pop       si
0x000000000000809a:  5A                   pop       dx
0x000000000000809b:  59                   pop       cx
0x000000000000809c:  5B                   pop       bx
0x000000000000809d:  CA 0C 00             retf      0xc
0x00000000000080a0:  8D 46 10             lea       ax, [bp + 0x10]
0x00000000000080a3:  8C DA                mov       dx, ds
0x00000000000080a5:  E8 B0 FD             call      0x7e58
0x00000000000080a8:  C9                   leave     
0x00000000000080a9:  5F                   pop       di
0x00000000000080aa:  5E                   pop       si
0x00000000000080ab:  5A                   pop       dx
0x00000000000080ac:  59                   pop       cx
0x00000000000080ad:  5B                   pop       bx
0x00000000000080ae:  CA 0C 00             retf      0xc
0x00000000000080b1:  3C 04                cmp       al, 4
0x00000000000080b3:  75 06                jne       0x80bb
0x00000000000080b5:  B8 04 00             mov       ax, 4
0x00000000000080b8:  E9 DD FE             jmp       0x7f98
...
0x00000000000080c5:  E9 D0 FE             jmp       0x7f98
0x00000000000080c8:  40                   inc       ax
0x00000000000080c9:  83 C2 02             add       dx, 2
0x00000000000080cc:  3D 89 00             cmp       ax, 0x89
0x00000000000080cf:  7D 03                jge       0x80d4
0x00000000000080d1:  E9 CD FE             jmp       0x7fa1
0x00000000000080d4:  E9 D9 FE             jmp       0x7fb0
0x00000000000080d7:  BA 00 80             mov       dx, 0x8000
0x00000000000080da:  31 DB                xor       bx, bx
0x00000000000080dc:  E9 10 FF             jmp       0x7fef
0x00000000000080df:  26 80 4F 14 20       or        byte ptr es:[bx + 0x14], 0x20
0x00000000000080e4:  C9                   leave     
0x00000000000080e5:  5F                   pop       di
0x00000000000080e6:  5E                   pop       si
0x00000000000080e7:  5A                   pop       dx
0x00000000000080e8:  59                   pop       cx
0x00000000000080e9:  5B                   pop       bx
0x00000000000080ea:  CA 0C 00             retf      0xc
...
0x00000000000081d3:  80 3E 15 22 00       cmp       byte ptr [0x2215], 0
...
0x0000000000008298:  81 C1 60 C4          add       cx, 0xc460
...
0x00000000000082db:  80 3E 14 22 04       cmp       byte ptr [0x2214], 4
...
0x000000000000836c:  81 C3 66 C4          add       bx, 0xc466
...
0x0000000000008382:  BB BA 01             mov       bx, 0x1ba
0x0000000000008385:  89 37                mov       word ptr ds:[bx], si
0x0000000000008387:  BB 34 07             mov       bx, 0x734
...
0x0000000000008421:  86 26 86 31          xchg      byte ptr [0x3186], ah
...
0x00000000000084da:  BB BA 01             mov       bx, 0x1ba
0x00000000000084dd:  89 37                mov       word ptr ds:[bx], si
0x00000000000084df:  BB 34 07             mov       bx, 0x734
...
0x00000000000084ea:  BF 34 07             mov       di, 0x734
...
0x0000000000008511:  BB BA 01             mov       bx, 0x1ba
