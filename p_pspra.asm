...
0x0000000000006d6c:  C6 07 05             mov   byte ptr ds:[bx], 5
label_11:
0x0000000000006d6f:  89 D3                mov   bx, dx
0x0000000000006d71:  80 3F 0A             cmp   byte ptr ds:[bx], 0xa
...
0x0000000000006d80:  8B 97 11 0E          mov   dx, word ptr ds:[bx + 0xe11]
...
0x0000000000006e27:  83 3F 28             cmp   word ptr ds:[bx], 0x28
...
0x0000000000006e65:  8B 97 15 0E          mov   dx, word ptr ds:[bx + 0xe15]
...
0x0000000000006e80:  8B 97 11 0E          mov   dx, word ptr ds:[bx + 0xe11]
...
0x0000000000006ec1:  83 3C 43             cmp   word ptr ds:[si], 0x43
...
0x0000000000006ed6:  80 3F 0A             cmp   byte ptr ds:[bx], 0xa
...
0x0000000000006f1c:  8B 97 11 0E          mov   dx, word ptr ds:[bx + 0xe11]
...
0x0000000000006f7c:  89 54 0A             mov   word ptr ds:[si + 0xa], dx
...
0x0000000000006f92:  80 3F 0A             cmp   byte ptr ds:[bx], 0xa
...
0x000000000000701f:  C7 47 08 00 00       mov   word ptr ds:[bx + 8], 0
0x0000000000007024:  C7 47 0A 20 00       mov   word ptr ds:[bx + 0xa], 0x20
...
0x0000000000007035:  8B 97 13 0E          mov   dx, word ptr ds:[bx + 0xe13]
...
0x000000000000705c:  8B 97 17 0E          mov   dx, word ptr ds:[bx + 0xe17]
...
0x000000000000731a:  8B 94 17 0E          mov   dx, word ptr ds:[si + 0xe17]
...
0x0000000000007447:  8B 97 17 0E          mov   dx, word ptr ds:[bx + 0xe17]
...
0x00000000000074ab:  8B 97 17 0E          mov   dx, word ptr ds:[bx + 0xe17]
...
0x0000000000007510:  8B 97 17 0E          mov   dx, word ptr ds:[bx + 0xe17]
...
0x00000000000075e8:  8B 97 17 0E          mov   dx, word ptr ds:[bx + 0xe17]
...
0x000000000000769a:  6B 77 22 2C          imul  si, word ptr ds:[bx + 0x22], 0x2c
