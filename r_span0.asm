...
SEGMENT R_SPAN0_TEXT USE16 PARA PUBLIC 'CODE'
...
SELFMODIFY_SPAN_destview_lo_1:
 ...
 mov   word ptr cs:[SELFMODIFY_SPAN_destview_add+2 - OFFSET R_SPAN0_STARTMARKER_], ax			; store base view offset
...
; call R_DrawSpan0_
db 09Ah
dw ((SPANFUNC_SEGMENT - COLORMAPS_SEGMENT) SHL 4) + (OFFSET R_DrawSpan0_ - OFFSET R_SPAN0_STARTMARKER_)
...
lodsw
mov   word ptr cs:[SELFMODIFY_SPAN_viewz_lo_1+1 - OFFSET R_SPAN0_STARTMARKER_], ax
lodsw
mov   word ptr cs:[SELFMODIFY_SPAN_viewz_hi_1+2 - OFFSET R_SPAN0_STARTMARKER_], ax

mov   ax, word ptr ds:[_destview+0]
mov   word ptr cs:[SELFMODIFY_SPAN_destview_lo_1+1 - OFFSET R_SPAN0_STARTMARKER_], ax

mov   al, byte ptr ds:[_extralight]
mov   byte ptr cs:[SELFMODIFY_SPAN_extralight_1+1 - OFFSET R_SPAN0_STARTMARKER_], al
...
pop   cx
pop   bx
mov   byte ptr cs:[(SELFMODIFY_SPAN_drawplaneiter+1) - OFFSET R_SPAN0_STARTMARKER_], 0
retf   
do_span_fixedcolormap_selfmodify:
mov   byte ptr cs:[SELFMODIFY_SPAN_fixedcolormap_2 + 5 - OFFSET R_SPAN0_STARTMARKER_], al
...
; modify instruction
mov   word ptr cs:[SELFMODIFY_SPAN_fixedcolormap_1 - OFFSET R_SPAN0_STARTMARKER_], ax
...
mov   bx, word ptr cs:[SELFMODIFY_SPAN_drawplaneiter+1 - OFFSET R_SPAN0_STARTMARKER_]
...
mov   byte ptr cs:[SELFMODIFY_SPAN_lookuppicnum+2 - OFFSET R_SPAN0_STARTMARKER_], cl 
mov   al, ch
xor   ah, ah
...
mov   word ptr cs:[SELFMODIFY_SPAN_comparestop+2 - OFFSET R_SPAN0_STARTMARKER_], ax ; set count value to be compared against in loop.
...
PROC R_WriteBackViewConstantsSpan0_ FAR
PUBLIC R_WriteBackViewConstantsSpan0_ 
...
ASSUME DS:R_SPAN0_TEXT


mov      al, byte ptr ss:[_skyflatnum]

mov      byte ptr ds:[SELFMODIFY_SPAN_skyflatnum + 2 - OFFSET R_SPAN0_STARTMARKER_], al
...
mov      byte ptr ds:[SELFMODIFY_SPAN_compare_span_counter+2        - OFFSET R_SPAN0_STARTMARKER_], 4
mov      byte ptr ds:[SELFMODIFY_SPAN_detailshift_mainloopcount_2+2 - OFFSET R_SPAN0_STARTMARKER_], 4
...
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_2+0 - OFFSET R_SPAN0_STARTMARKER_], ax  
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_2+2 - OFFSET R_SPAN0_STARTMARKER_], ax  ; shl   ax, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+0 - OFFSET R_SPAN0_STARTMARKER_], ax  ; shl   ax, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+2 - OFFSET R_SPAN0_STARTMARKER_], ax  ; shl   ax, 1
mov ax, 0FAD1h  ; shr   dx, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_1+0 - OFFSET R_SPAN0_STARTMARKER_], ax  
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_1+2 - OFFSET R_SPAN0_STARTMARKER_], ax  ; sar   dx, 1
mov ax, 0F9d1h  ; sar   cx, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+0 - OFFSET R_SPAN0_STARTMARKER_], ax  
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+2 - OFFSET R_SPAN0_STARTMARKER_], ax  ; sar   cx, 1
...
mov      byte ptr ds:[SELFMODIFY_SPAN_compare_span_counter+2        - OFFSET R_SPAN0_STARTMARKER_], 2
mov      byte ptr ds:[SELFMODIFY_SPAN_detailshift_mainloopcount_2+2 - OFFSET R_SPAN0_STARTMARKER_], 2
...
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_1+0 - OFFSET R_SPAN0_STARTMARKER_], 0FAD1h  ; sar   dx, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+0 - OFFSET R_SPAN0_STARTMARKER_], 0F9D1h  ; sar   cx, 1
mov      ax, 0E0D1h
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_2+0 - OFFSET R_SPAN0_STARTMARKER_], ax  ; shl   ax, 1
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+0 - OFFSET R_SPAN0_STARTMARKER_], ax  ; shl   ax, 1


mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_1+2 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_2+2 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+2 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+2 - OFFSET R_SPAN0_STARTMARKER_], ax
...
mov      byte ptr ds:[SELFMODIFY_SPAN_compare_span_counter+2        - OFFSET R_SPAN0_STARTMARKER_], 1
mov      byte ptr ds:[SELFMODIFY_SPAN_detailshift_mainloopcount_2+2 - OFFSET R_SPAN0_STARTMARKER_], 1
...
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+0 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_3+2 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+0 - OFFSET R_SPAN0_STARTMARKER_], ax
mov      word ptr ds:[SELFMODIFY_SPAN_detailshift2minus_4+2 - OFFSET R_SPAN0_STARTMARKER_], ax
