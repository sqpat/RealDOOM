...
0x00000000000037cf:  BF 2C 00          mov         di, 0x2c
0x00000000000037d2:  89 46 FA          mov         word ptr [bp - 6], ax
0x00000000000037d5:  B8 00 10          mov         ax, 0x1000
...
0x000000000000381e:  77 52             ja          0x3872
0x0000000000003820:  30 E4             xor         ah, ah
0x0000000000003822:  89 C7             mov         di, ax
0x0000000000003824:  01 C7             add         di, ax
0x0000000000003826:  2E FF A5 5C 37    jmp         word ptr cs:[di + 0x375c]
label_12:
0x000000000000382b:  EB 58             jmp         0x3885
...
0x0000000000003860:  E8 14 13          call        0x4b77
...
0x0000000000003880:  7C 03             jl          0x3885
...
0x00000000000038a9:  E8 76 02          call        0x3b22
...
0x0000000000003905:  E9 65 FF          jmp         0x386d
...
0x0000000000003935:  E9 35 FF          jmp         0x386d
...
0x0000000000003965:  E9 05 FF          jmp         0x386d
...
0x000000000000397a:  98                cwde        
0x000000000000397b:  89 C6             mov         si, ax
0x000000000000397d:  01 C6             add         si, ax
0x000000000000397f:  8B 84 58 09       mov         ax, word ptr ds:[si + 0x958]
0x0000000000003983:  85 C0             test        ax, ax
0x0000000000003985:  74 52             je          0x39d9
0x0000000000003987:  6B D8 2C          imul        bx, ax, 0x2c
0x000000000000398a:  8A 87 11 34       mov         al, byte ptr ds:[bx + 0x3411]
0x000000000000398e:  98                cwde        
...
0x00000000000039d2:  8B 87 58 09       mov         ax, word ptr ds:[bx + 0x958]
0x00000000000039d6:  E8 43 10          call        0x4a1c
0x00000000000039d9:  FE C1             inc         cl
0x00000000000039db:  80 F9 1E          cmp         cl, 0x1e
0x00000000000039de:  7C 98             jl          0x3978
...
0x00000000000039ef:  98                cwde        
0x00000000000039f0:  89 C3             mov         bx, ax
0x00000000000039f2:  01 C3             add         bx, ax
0x00000000000039f4:  83 BF 58 09 00    cmp         word ptr ds:[bx + 0x958], 0
0x00000000000039f9:  74 0B             je          0x3a06
0x00000000000039fb:  FE C2             inc         dl
0x00000000000039fd:  80 FA 1E          cmp         dl, 0x1e
0x0000000000003a00:  7C EB             jl          0x39ed
0x0000000000003a02:  5A                pop         dx
0x0000000000003a03:  59                pop         cx
0x0000000000003a04:  5B                pop         bx
0x0000000000003a05:  C3                ret         
0x0000000000003a06:  89 8F 58 09       mov         word ptr ds:[bx + 0x958], cx
...
0x0000000000003a18:  98                cwde        
0x0000000000003a19:  89 C3             mov         bx, ax
0x0000000000003a1b:  01 C3             add         bx, ax
0x0000000000003a1d:  8B 87 58 09       mov         ax, word ptr ds:[bx + 0x958]
0x0000000000003a21:  39 C1             cmp         cx, ax
0x0000000000003a23:  74 0C             je          0x3a31
0x0000000000003a25:  FE C2             inc         dl
0x0000000000003a27:  80 FA 1E          cmp         dl, 0x1e
0x0000000000003a2a:  7C EA             jl          0x3a16
