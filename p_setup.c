...
void __near Z_FreeConventionalAllocations() {
	...
	for (i = 0; i < 4; i++) {
		...
		pageswapargs[pageswapargs_rend_offset + i * 2]	  = 	_EPRRuntime(FIRST_TEXTURE_LOGICAL_PAGE + i);
		pageswapargs[pageswapargs_spritecache_offset + i * 2] = _EPRRuntime(FIRST_SPRITE_CACHE_LOGICAL_PAGE + i);
