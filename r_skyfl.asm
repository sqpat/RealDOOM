...
PROC  R_DrawSkyColumnDynamicFL_ NEAR
PUBLIC  R_DrawSkyColumnDynamicFL_
    ; ax contains dc_yh...
    ; dx contails dc_yl...  
    ; bx contains dc_x (don't modify)
    ; NOTE ah may be garbage but dh is 0
 ...
 ; regardless, i really want to avoid using a branch to cap the value to 127, so we take this sort of half measure 
    ...
    mov   word ptr cs:[((OFFSET SELFMODIFY_SKY_unrolled_dynamic_jump_location + 1) - R_SKYFL_STARTMARKER_)], ax   ; modify the jump
...
call  R_DrawSkyColumnDynamicFL_
