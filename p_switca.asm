...
shl   bx, 2
mov   al, byte ptr es:[si + LINE_PHYSICS_T.lp_tag]
mov   cl, byte ptr es:[si + LINE_PHYSICS_T.lp_special]
...
jne   exit_usespecialline_return_0
...
jne   exit_usespecialline_return_0
cmp   cl, 1
jb    exit_usespecialline_return_0
ja    continue_checking_cases
label_1:
...
pop   si
retf  
continue_checking_cases:
cmp   cl, 32
jb    exit_usespecialline_return_0
cmp   cl, 34
jbe   label_1
exit_usespecialline_return_0:
xor   al, al
LEAVE_MACRO 
pop   di
pop   si
...
test  ax, ax
jne   label_7
jump_to_exit_usespecialline_return_1_10:
jmp   exit_usespecialline_return_1
label_7:
push  1
mov   al, byte ptr [bp - 2]
...
test  ax, ax
jne   label_9
jump_to_exit_usespecialline_return_1_8:
jmp   exit_usespecialline_return_1
label_9:
push  1
mov   al, byte ptr [bp - 2]
...
call  EV_DoFloor_
test  ax, ax
je    jump_to_exit_usespecialline_return_1_8
push  1
mov   al, byte ptr [bp - 2]
mov   dx, word ptr [bp - 6]
xor   ah, ah
...
test  ax, ax
jne   label_10
jump_to_exit_usespecialline_return_1_7:
jmp   exit_usespecialline_return_1
label_10:
push  1
mov   bl, byte ptr [bp - 2]
...
call  EV_DoDoor_
test  ax, ax
je    jump_to_exit_usespecialline_return_1_7
push  1
mov   bl, byte ptr [bp - 2]
mov   dx, word ptr [bp - 6]
mov   cx, si
