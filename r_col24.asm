...
MARKER_SELFMODIFY_COLFUNC_subtract_centery24_1_:
PUBLIC MARKER_SELFMODIFY_COLFUNC_subtract_centery24_1_
    sub   ax, 01000h
...
MARKER_SELFMODIFY_COLFUNC_subtract_centery24_2_:
PUBLIC MARKER_SELFMODIFY_COLFUNC_subtract_centery24_2_
    sub   ax, 01000h
...
MARKER_SELFMODIFY_COLFUNC_set_destview_segment24_noloop_:
PUBLIC MARKER_SELFMODIFY_COLFUNC_set_destview_segment24_noloop_
   mov     ax, 01000h   
...
MARKER_SELFMODIFY_COLFUNC_jump_offset24_noloop_:
PUBLIC MARKER_SELFMODIFY_COLFUNC_jump_offset24_noloop_
