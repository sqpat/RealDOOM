...
mov   word ptr es:[((SELFMODIFY_COLFUNC_jump_offset24+1))+COLFUNC_JUMP_AND_FUNCTION_AREA_OFFSET_DIFF], ax  ; overwrite the jump relative call for however many iterations in unrolled loop we need
...
MOV  ES, SI
MOV  SI, DX
MOV  word ptr cs:[_selfmodify_restore_original_ax- OFFSET R_MASK24_STARTMARKER_+1], AX
MUL  BX
MOV  word ptr cs:[_selfmodify_restore_dx- OFFSET R_MASK24_STARTMARKER_+1], DX
MOV  AX, SI
MUL  CX
XCHG AX, SI
CWD
