...
SEGMENT R_SPANFL_TEXT USE16 PARA PUBLIC 'CODE'
ASSUME  CS:R_SPANFL_TEXT
...
mov       word ptr cs:[SELFMODIFY_SPAN_draw_skyplane_call + 2 - OFFSET R_SPANFL_STARTMARKER_], ax
