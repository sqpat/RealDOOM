...
_weapondata:
dw ST_ARMSX + 0 * ST_ARMSXSPACE,  ST_ARMSY + 0 * ST_ARMSYSPACE, -1, OFFSET _arms + 0 * 2
dw ST_ARMSX + 1 * ST_ARMSXSPACE,  ST_ARMSY + 0 * ST_ARMSYSPACE, -1, OFFSET _arms + 1 * 2
dw ST_ARMSX + 2 * ST_ARMSXSPACE,  ST_ARMSY + 0 * ST_ARMSYSPACE, -1, OFFSET _arms + 2 * 2
dw ST_ARMSX + 0 * ST_ARMSXSPACE,  ST_ARMSY + 1 * ST_ARMSYSPACE, -1, OFFSET _arms + 3 * 2
dw ST_ARMSX + 1 * ST_ARMSXSPACE,  ST_ARMSY + 1 * ST_ARMSYSPACE, -1, OFFSET _arms + 4 * 2
dw ST_ARMSX + 2 * ST_ARMSXSPACE,  ST_ARMSY + 1 * ST_ARMSYSPACE, -1, OFFSET _arms + 5 * 2
